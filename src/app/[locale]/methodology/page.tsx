...
<h2>Ալգորիթմային օգնություն խմբագրումին</h2>
<p>V2-ում բառարանը Հերունի-ոճով վերակառուցումներ ստեղծում է մեր ալգորիթմներով. համակարգը սնուցվում է 162-անդամ ՏԲ աղյուսակով, Հերունիի ~80 ձեռքով գրված օրինակներով, և մեր խմբագիրների ստեղծած ձևանմուշների կատալոգով: <strong>Ոչ մի ալգորիթմային տարբերակ չի հրապարակվում ինքնաբերաբար</strong>. յուրաքանչյուր սևագիր պետք է հաստատվի մարդ-խմբագրի կողմից: Որտեղ նայում եք ստուգված չէ սևագիր էջ, այն նշվում է «մեր ալգորիթմները, չստուգված»: Ամեն բառի էջի ներքևից հղումով կարող եք տեսնել՝ տվյալ բառի ալգորիթմային տարբերակը խմբագիրն ինչպես է ստուգել, շտկել կամ ընդունել:</p>
...
<h2>Algorithm-assisted editing</h2>
<p>In v2, Heruni-style reconstructions are drafted by our algorithms, grounded in the 162-entry ՏԲ table, Heruni's ~80 hand-written examples, and our editor-built catalogue of rhetorical patterns. <strong>No algorithm output is ever auto-published.</strong> Every draft lands in a review queue; a human editor approves, edits, or rejects it before it reaches the public dictionary. Drafts that have not yet been approved are marked "our algorithms, unreviewed" wherever they appear. Each published entry preserves the link back to the original algorithm-generated draft, so a reader (or another editor) can inspect what our system proposed and how the editor changed it.</p>
