...
<h2>ԱԻ-ով ստեղծված բովանդակություն</h2>
<p>V2-ում բառարանի մի մասն առաջին սևագիրը ստանում է Claude ԱԻ մոդելից: <strong>Ոչ մի ԱԻ-սևագիր չի հրապարակվում առանց մարդ-խմբագրի ստուգման:</strong> Սակայն «վերծանել»-ով անհատական բառեր որոնելիս դուք կարող եք ստանալ իրական ժամանակում ստեղծված ԱԻ վերծանում, որը դեռ ստուգված չէ և նշված է որպես այդպիսին: Մի՛ օգտագործեք այդ ոչ-ստուգված արդյունքները որպես ակադեմիական աղբյուր:</p>
...
<p>In v2, part of the first-draft writing comes from Anthropic's Claude AI model. <strong>No AI output is published without editor review.</strong> When you search an ad-hoc word on the Decompose page, however, you may see a real-time AI reconstruction that has not yet been reviewed — it is clearly labelled as such. Do not cite unreviewed AI output as an academic source.</p>
